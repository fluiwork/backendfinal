...
app.post('/owner-tokens', async (req, res) => {
  try {
    ...
    // FILTRO CRÍTICO: Verificar saldo actual en tiempo real
    let tokens = [];
    ...
    // FILTRO ADICIONAL: Verificar saldos actualizados
...
// ... el resto del código del backend permanece igual ...
// [Nota: Mantener todo el código restante sin cambios]
